...
TEMPLATES = {
    ...
    # ==================== 统计类竞赛模板（stat-model-paper专用） ====================
    "市场调查与分析": {
        "name": "全国大学生市场调查与分析大赛",
        "aliases": ["市场调查", "市场调查大赛", "市调大赛", "CRA"],
        "language": "zh",
        "sections": [
            "封面 + 表格和插图清单",
            "中文摘要 + 英文Abstract",
            "一、引言（研究背景 + 文献综述 + 研究问题）",
            "二、调查方案设计（抽样设计 + 问卷设计 + 预调查 + 信效度检验）",
            "三、描述性统计分析（样本特征 + 变量分布 + 交叉分析）",
            "四、推断性统计分析（假设检验 + 回归/方差分析 + 结构方程模型）",
            "五、结论与建议",
            "参考文献",
            "附录（问卷 + 代码 + 补充表格）",
            "致谢",
        ...
        "must_have": [
            "抽样方案（抽样方法 + 样本量计算 + 抽样框）",
            "问卷或量表设计（附在附录）",
            "信度和效度检验（Cronbach α + KMO + Bartlett球形检验）",
            "描述性统计 + 推断性统计",
            "结论中的营销/政策建议",
        ],
        "style_notes": [
    ...
    "计量经济学论文": {
        "name": "全国大学生计量经济学论文大赛",
        "aliases": ["计量经济学", "计量论文", "计量大赛"],
        "language": "zh",
        "sections": [
            "封面 + 中英文摘要",
            "一、引言（研究背景 + 文献综述 + 边际贡献）",
            "二、理论分析与研究假说",
            "三、研究设计（数据来源 + 变量定义 + 模型设定 + 识别策略）",
            "四、实证结果（基准回归 + 内生性处理 + 稳健性检验 + 异质性分析）",
            "五、结论与政策建议",
            "参考文献",
            "附录（代码 + 补充回归表）",
            "致谢",
        ...
        "must_have": [
            "研究假说（基于理论推导，不少于2个）",
            "识别策略（IV/DID/RDD/PSM 至少一种）",
            "一阶段F值或平行趋势检验",
            "稳健性检验（≥3种方法）",
            "标准误聚类（cluster at appropriate level）",
        ],
        "style_notes": [
            "严格遵循AER/Econometrica等顶刊风格",
            "每个系数必须报告标准误和显著性星号",
            "表格下方标注N、R²、F统计量",
            "实证结果必须联系理论假说进行讨论",
        ],
    ...
    "能源经济学术": {
        "name": "全国大学生能源经济学术论文大赛",
        "aliases": ["能源经济", "能源经济大赛", "能源学术"],
        "language": "zh",
        "sections": [
            "封面 + 中英文摘要",
            "一、引言",
            "二、文献综述与理论框架",
            "三、方法与数据（模型设定 + 变量 + 数据来源）",
            "四、实证结果与讨论",
            "五、结论与政策建议",
            "参考文献",
            "附录",
    ...
    "挑战杯-社科": {
        "name": "挑战杯全国大学生课外学术科技作品竞赛（社会科学类）",
        "aliases": ["挑战杯", "挑战杯社科", "大挑"],
        "language": "zh",
        "sections": [
            "封面",
            "中文摘要 + 英文Abstract",
